...
<body>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="inscricaoForm" method="POST" action="cursos.php">
    ...
    <div class="modal fade" id="novoCursoModal" tabindex="-1" aria-labelledby="novoCursoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="novoCursoForm" method="POST" action="cursos.php">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function buscarAlunos() {
            ...
            fetch('cursos.php?acao=buscar_alunos&termo=' + encodeURIComponent(termo))
        ...
        if (cursoSelect) {
            cursoSelect.addEventListener('change', function() {
                ...
                if (cursoId) {
                    ...
                    fetch('cursos.php?acao=obter_turmas&curso_id=' + cursoId)
                        .then(response => response.json())
                        .then(data => {
                            if (data.sucesso) {
        ...
        function verificarInscricao() {
            ...
            if (alunoIdValue && cursoIdValue) {
                fetch('cursos.php?acao=verificar_inscricao&aluno_id=' + alunoIdValue + '&curso_id=' + cursoIdValue)
                    .then(response => response.json())
                    .then(data => {
                        if (data.sucesso) {
                            if (data.inscrito) {
        ...
        if (detalhesModal) {
            detalhesModal.addEventListener('show.bs.modal', function(event) {
                ...
                fetch('cursos.php?acao=obter_detalhes_curso&curso_id=' + cursoId)
                    .then(response => response.json())
                    .then(data => {
                        if (data.sucesso) {
        ...
        if (editarInscricaoModal) {
            ...
            if (editarInscricaoForm) {
                editarInscricaoForm.addEventListener('submit', function(e) {
                    ...
                    fetch('cursos.php?acao=atualizar_inscricao', {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => response.json())
