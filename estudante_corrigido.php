...
<body>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="tabelaEstudantes">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="https://via.placeholder.com/40?text=Foto" 
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="estudante.php" method="POST" enctype="multipart/form-data" class="row g-3">
                                    ...
                                    <!-- Campo de inscrição removido pois não existe na tabela alunos -->
                                    <div class="col-md-4">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form action="estudante.php" method="POST" enctype="multipart/form-data" class="row g-3">
                                    ...
                                    <input type="hidden" name="usuario_id" value="<?php echo $estudante['usuario_id']; ?>">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (document.getElementById('tabelaEstudantes')) {
